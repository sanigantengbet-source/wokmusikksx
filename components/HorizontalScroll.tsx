      ...
      <div className="flex overflow-x-auto no-scrollbar gap-4 px-4 pr-10 pb-4 snap-x snap-mandatory scroll-smooth w-full">
        {tracks.map((track, i) => {
          ...
          return (
            ...
            >
              <div className="relative w-36 h-36 rounded-xl overflow-hidden mb-2 shadow-lg transition-transform duration-300 bg-white/5">
                <SmoothImage src={thumbnail} alt={track.name} fill sizes="144px" className="object-cover" />
              ...
              <MarqueeText text={artistName} className="text-xs text-white/60 mt-1" />
            </motion.div>
          );
        })}
      </div>
