    ...
    <main className="min-h-screen pb-32">
      ...
      <div className="flex flex-col items-center px-4 mt-4 mb-8">
        ...
        <div className="flex items-center gap-4">
          <button className="w-12 h-12 rounded-full liquid-glass-icon flex items-center justify-center text-white hover:scale-105 transition-all" title="Acak">
            <Shuffle className="w-5 h-5" />
          </button>
          <button 
            className="w-16 h-16 liquid-glass-green rounded-full flex items-center justify-center hover:scale-105 transition-all shadow-xl"
            onClick={() => topTracks.length > 0 && playTrack(topTracks[0], topTracks)}
            title="Putar"
          >
            <Play className="w-8 h-8 text-zinc-950 fill-current ml-1" />
          </button>
          <button className="w-12 h-12 rounded-full liquid-glass-icon flex items-center justify-center text-white hover:scale-105 transition-all" title="Opsi">
      ...
      <div className="px-4 mb-4">
        <h3 className="text-xs font-semibold uppercase tracking-wider text-white/70">Sepanjang waktu</h3>
      </div>
