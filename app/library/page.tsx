...
export default function Library() {
  ...
  return (
    <main className="min-h-screen pt-6 px-4 pb-32">
      <div className="flex overflow-x-auto no-scrollbar gap-2.5 mb-6 snap-x snap-mandatory scroll-smooth -mx-4 px-4 pr-12 w-[calc(100%+2rem)]">
        {tabs.map((tab) => (
          <button
            key={tab}
      ...
      <div className="flex justify-between items-center mb-6 text-white/80 text-sm">
        <button className="flex items-center gap-2 liquid-glass-pill px-3 py-1.5 rounded-full text-xs font-medium text-white/80 hover:text-white">
          Tanggal ditambahkan <span className="text-xs">↓</span>
        </button>
        <button className="w-8 h-8 rounded-full liquid-glass-icon flex items-center justify-center text-white/80 hover:text-white">
      ...
      {activeTab === 'Daftar putar' && (
        <div className="space-y-2">
          <div className="flex items-center gap-4 p-3 hover:bg-white/5 rounded-xl cursor-pointer transition-colors" onClick={() => setActiveTab('Lagu')}>
            <div className="w-12 h-12 rounded-xl liquid-glass-icon flex items-center justify-center shrink-0 text-white">
              <Heart className="w-6 h-6 text-[#FA243C] fill-[#FA243C]" />
            </div>
          ...
          >
            <div className="w-12 h-12 rounded-xl liquid-glass-icon flex items-center justify-center shrink-0 text-[#81B29A]">
          ...
          {playlists.map((pl) => (
            ...
            >
              ...
              <button
                ...
                className="w-8 h-8 rounded-full liquid-glass-icon flex items-center justify-center text-white/50 hover:text-white transition-all mr-1"
              ...
              <button
                ...
                className="w-8 h-8 rounded-full liquid-glass-icon flex items-center justify-center text-white/50 hover:text-red-500 transition-all"
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {likedSongs.length > 0 && (
              <button
                ...
                className="w-10 h-10 liquid-glass-button bg-white text-black rounded-full flex items-center justify-center hover:scale-105 transition-transform shadow-lg"
              >
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {savedAlbums.map((album) => (
              ...
              >
                <div className="relative w-full aspect-square rounded-xl overflow-hidden mb-3 shadow-lg bg-white/5">
                  <SmoothImage 
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {subscribedArtists.map((artist) => (
              ...
              >
                <div className="relative w-24 h-24 rounded-full overflow-hidden mb-3 shadow-lg bg-white/10">
                  <SmoothImage 
          ...
          <div className="bg-[#1C1C1E] rounded-2xl p-6 w-full max-w-sm border border-white/10">
            ...
            <div className="flex justify-center mb-6">
              <label className="relative w-32 h-32 rounded-xl overflow-hidden cursor-pointer group bg-white/5 flex items-center justify-center border border-dashed border-white/20 hover:border-white/50 transition-colors">
                {newPlaylistImg ? (
                  <SmoothImage src={newPlaylistImg} alt="Preview" fill sizes="144px" className="object-cover" />
                ) : (
